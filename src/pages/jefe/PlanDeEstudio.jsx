...
const PlanDeEstudio = () => {
  ...
  const filteredGrupos = useMemo(() => {
    ...
    return grupos.filter((g) => {
      if (filterSemestre && String(g.semestre) !== String(filterSemestre))
        return false;
      if (!txt) return true;
      return (
...
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
    setModalOpen(true);
  };
...
=======
    setEditableHorarios((prev) => [
      ...prev,
      { dia: "LUNES", hora_inicio: "07:00", hora_fin: "08:00", salon: "" },
    ]);
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
  };
...
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
      ...
      await matriculaService.updateGrupoHorario(
        modalGrupo.id,
        payloadHorarios,
        editableDocente,
      );
      ...
      setGrupos((prev) =>
        prev.map((g) =>
          g.id === modalGrupo.id
            ? { ...g, horarios: payloadHorarios, docente: editableDocente }
            : g,
        ),
      );
...
=======
    if (!horarios || horarios.length === 0) return "Sin horario definido";
    return horarios
      .map((h) => `${h.dia.substring(0, 3)} ${h.hora_inicio}-${h.hora_fin}`)
      .join(" | ");
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
  };
  ...
  return (
    <div className="plan-container">
      <div className="plan-header">
        ...
        <p>
          Selecciona un pensum para ver y editar los grupos (horarios) de cada
          asignatura.
        </p>
      </div>
      ...
      <div className="plan-controls">
        <div className="control-block">
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            <button
              className="btn"
              onClick={() => setPensumQuery(searchPensum)}
          ...
          <div className="pensum-list">
            {pensums
              .filter((p) =>
                p.nombre
                  .toLowerCase()
                  .includes(pensumQuery.trim().toLowerCase()),
              )
              .map((p) => (
                <div
                  key={p.id}
      ...
      <div className="plan-list">
        <h3>
          Grupos del pensum{" "}
          {selectedPensumId ? `#${selectedPensumId}` : "(ninguno seleccionado)"}
        ...
        {selectedPensumId == null ? (
          ...
          <div className="empty">
            No hay grupos disponibles para este pensum en el periodo activo.
          </div>
        ) : (
...
=======
                <div
                  className="asig-meta"
                  style={{ marginTop: 4, fontSize: "0.85em", color: "#666" }}
                >
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
...
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
              <p className="dialog-title">
                Editar grupo — {modalGrupo.codigo} (
                {modalGrupo.asignatura_nombre})
              </p>
...
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
              ...
              <div
                style={{ maxHeight: 320, overflow: "auto", marginBottom: 8 }}
              >
...
=======
                    <div key={idx} className="plan-horario-row">
                      <select
                        value={h.dia}
                        onChange={(e) =>
                          updateHorarioField(idx, "dia", e.target.value)
                        }
                      >
                        {[
                          "LUNES",
...
>>>>>>> 86f1a3c (Refactor Plan Page and Remove Env Example)
                      ...
                      <input
                        ...
                        value={h.hora_inicio}
                        onChange={(e) =>
                          updateHorarioField(idx, "hora_inicio", e.target.value)
                        }
                      />
                      <input
                        type="time"
                        value={h.hora_fin}
                        onChange={(e) =>
                          updateHorarioField(idx, "hora_fin", e.target.value)
                        }
                      />
                      <input
                        type="text"
                        className="input-text plan-horario-salon"
                        placeholder="Salón"
                        value={h.salon}
                        onChange={(e) =>
                          updateHorarioField(idx, "salon", e.target.value)
                        }
                      />
                      <button
                        className="btn btn-clear"
